...
import type { Order as _Order, OrderStatus as _OrderStatus, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getOrderDetails(arg0: string): Promise<Order> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrderDetails(arg0);
    ...
    async getOrderStatus(arg0: string): Promise<OrderStatus> {
        if (this.processError) {
            try {
                ...
                return from_candid_OrderStatus_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "shipped" in value ? OrderStatus.shipped : "etching" in value ? OrderStatus.etching : "designing" in value ? OrderStatus.designing : value;
}
